...
for(var name in module){object[name]=module[name];}},addSuperMethod=function(name,definition){var superclass=currentClass!==null&&currentClass.superclass!==undefined&&currentClass.superclass.prototype;if(superclass&&typeof definition==="function"&&typeof superclass[name]==="function"&&containsSuper.test(definition)){return function(){this._super=superclass[name];var result=definition.apply(this,arguments);this._super=undefined;return result;};}
